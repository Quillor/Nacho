  ...
  return (
    <div className="space-y-16">
      ...
      <section className="space-y-8">
        <h2 className="text-3xl font-display font-black uppercase border-b-4 border-foreground pb-2">Default</h2>
...
<Alert>
  ...
  <AlertDescription>
    You can add components to your app using the cli.
      ...
      <section className="space-y-8">
        <h2 className="text-3xl font-display font-black uppercase border-b-4 border-foreground pb-2">Destructive</h2>
        <div className="p-8 border-4 border-foreground rounded-sm bg-background/50">
