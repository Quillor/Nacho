    ...
    <section className="border-4 border-foreground bg-background shadow-md">
      <header className="flex flex-col gap-4 border-b-4 border-foreground bg-primary p-6 md:flex-row md:items-center">
        ...
        <div>
          ...
          <h3 className="font-display text-2xl font-black uppercase leading-none text-foreground md:text-3xl">
            {title}
          </h3>
        </div>
      </header>
...
const PRINCIPLES = [
  {
    name: "Confident",
    body: "We know our product is good, so we say it plainly. No hedging, no “maybe”, no “we think”. State the benefit and move on.",
  },
  {
    name: "Chunky",
    body: "Short words, short sentences. Heavy verbs over flabby nouns. If a word isn't pulling weight, cut it. Copy should feel as bold as the type.",
  },
  {
    name: "Playful",
    body: "We have a sense of humor and a snack-brand grin. A wink is welcome — as long as it never gets in the way of the task.",
  },
  {
    name: "Loud & Clear",
    body: "We don't do subtle. Lead with the most important thing, in the fewest words. The user should never have to hunt for the point.",
  },
  {
    name: "Accessible",
    body: "Plain language beats clever jargon. Write for someone in a hurry on their phone. Clarity is the highest form of confidence.",
  },
];
...
const TONES = [
  {
    when: "Success",
    tone: "Celebratory",
    body: "Throw a little confetti. Short, upbeat, and a touch proud. “Published!”, “Link copied”, “Saved”.",
  },
  {
    when: "Errors & failures",
    tone: "Calm & helpful",
    body: "Drop the jokes, never blame the user. Say what happened and the one thing they can do next.",
  },
  {
    when: "Empty & first-run",
    tone: "Encouraging",
    body: "Invite, don't apologize. An empty screen is a starting line, not a dead end.",
  },
  {
    when: "Destructive actions",
    tone: "Plain & honest",
    body: "Slow down and be specific. Name exactly what will happen and whether it can be undone.",
  },
  {
    when: "Marketing & landing",
    tone: "Loud & swaggering",
    body: "Biggest voice in the room. Bold claims, punchy rhythm, all the personality.",
  },
];
  ...
  return (
    <div className="space-y-16">
      ...
      <div className="space-y-4">
        ...
        <h1 className="font-display text-5xl font-black uppercase leading-[0.9] tracking-tight text-foreground md:text-6xl">
          Voice &amp; Tone
        </h1>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="border-4 border-foreground bg-foreground p-6 text-background shadow-md">
          <h2 className="mb-2 font-display text-2xl font-black uppercase text-primary">
            Voice
          </h2>
        ...
        <div className="border-4 border-foreground bg-background p-6 shadow-md">
          <h2 className="mb-2 font-display text-2xl font-black uppercase">
            Tone
          </h2>
      ...
      <section className="space-y-8">
        <h2 className="border-b-4 border-foreground pb-2 font-display text-3xl font-black uppercase">
          Voice Principles
        </h2>
      ...
      <section className="border-4 border-foreground bg-primary p-8 shadow-md md:p-12">
        <h2 className="font-display text-3xl font-black uppercase leading-tight text-foreground md:text-4xl">
          The 5-second test
        </h2>
