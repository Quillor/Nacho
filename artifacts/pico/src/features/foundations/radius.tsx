 ...
 <h1 className="text-5xl md:text-6xl font-display font-extrabold tracking-tight leading-[0.9] text-foreground">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="space-y-4">
          ...
          <div className="h-32 bg-accent border-2 border-foreground rounded-sm shadow-md flex items-center justify-center">
        ...
        <div className="space-y-4">
          ...
          <div className="h-32 bg-accent border-2 border-foreground rounded-md shadow-md flex items-center justify-center">
        ...
        <div className="space-y-4">
          ...
          <div className="h-32 bg-accent border-2 border-foreground rounded-full shadow-md flex items-center justify-center">
