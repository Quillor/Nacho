...
>(({ ...props }, ref) => (
  <DialogPrimitive.Trigger ref={ref} {...picoMeta("DialogTrigger")} {...props} />
))
...
>(({ ...props }, ref) => (
  <DialogPrimitive.Close ref={ref} {...picoMeta("DialogClose")} {...props} />
))
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Centered fade only — no slide/zoom transform, so the dialog appears in
        // place rather than flying in (keeps the chunky Pico look steady).
